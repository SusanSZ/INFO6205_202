...
public class Env extends Nature{
	...
	private void setMutationPos() {
		...
		if(midscore <= 0.010) mutation_pos_percentage = 35;
		else if(midscore <= 0.013) mutation_pos_percentage = 30;
		else if(midscore <= 0.016) mutation_pos_percentage = 25;
		else if(midscore <= 0.019) mutation_pos_percentage = 20;
		else if(midscore <= 0.022) mutation_pos_percentage = 15;
		else if(midscore <= 0.025) mutation_pos_percentage = 10;
		else mutation_pos_percentage = 5;
	}//变异率自适应
