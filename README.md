...
## How to run the application
  ...
  <p>      </p>(a). Only _`PNG`_ image is accepted.<br>
  <p>      </p>(b). make sure the _`color model`_ is _`32bit`_.<br>
  <p>      </p>(c). name the png file as _`test.png`_.<br>
  <p>      </p>(d). dimensions better less than 200x200 (I would recommend 75x75).<br>
